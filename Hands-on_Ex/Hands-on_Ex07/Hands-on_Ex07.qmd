...
2. Attribute data handling: tidyverse, especially readr, ggplot2 and dplyr
3. Choropleth mapping: tmap
4. Multivariate data visualisation and analysis: coorplot, ggpubr, and heatmaply
5. Cluster analysis: cluster, ClustGeo
...
2. Shan-ICT.csv: This is an extract of [The 2014 Myanmar Population and Housing Census](Myanmarhttps://myanmar.unfpa.org/en/publications/2014-population-and-housing-census-myanmar-data-sheet) at the township level.
...
We will use skater() from spded

## 1. Convert into SpatialPolygonsDataFrame
...
head(shan.mst)
```
## 4. Compating Spatially Constrained Clusters With SKATER Method
```{r}
